...
var treeData = [
{
  ...
  "children":[
    ...
    $sql_query = "SELECT distinct name,iid FROM instructor";
    // echo "$sql_query";
    $result = $mysqli->query($sql_query);
    while ($stud = $result->fetch_assoc()) {
      echo "{";
      ...
      echo $stud['name'];
      echo "' ,";
      echo  "'parent': 'All instructors',";
      echo "'children': [";
      // echo "{";
      //for department
      $sql_query2 = "SELECT distinct d.name as name FROM department d, instructor i, belong2 b where b.iid = i.iid and b.did = d.did and i.iid = ".$stud['iid'];
      ...
      $sql_query1 = "SELECT distinct c.name as name FROM instructor i, course c, teach t where c.cid = t.cid and t.iid = i.iid and i.iid = ".$stud['iid'];
