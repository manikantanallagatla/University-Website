...
var treeData = [
{
  ...
  "children":[
    ...
    $sql_query = "SELECT distinct name,sid FROM student";
    // echo "$sql_query";
    $result = $mysqli->query($sql_query);
    while ($stud = $result->fetch_assoc()) {
      echo "{";
      ...
      echo $stud['name'];
      echo "' ,";
      echo  "'parent': 'All students',";
      echo "'children': [";
      $sql_query1 = "SELECT distinct c.name as name FROM student s, course c, takes t where c.cid = t.cid and t.sid = s.sid and s.sid = ".$stud['sid'];
